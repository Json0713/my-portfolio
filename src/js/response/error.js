...
export function show404(name) {
  ...
  if (!sessionStorage.getItem('toast:404')) {
    showToast(
      "<i class='bi bi-exclamation-triangle-fill'></i> This page doesn't exist or is under development.",
      { type: 'danger' }
    );
  ...
  app.innerHTML = `
    <div class="coming-soon text-center d-flex flex-column justify-content-center align-items-center p-4" style="min-height: 70vh;">
      ...
      <p class="lead">This page does not yet exist, or is still under development!</p>
      <div class="d-flex justify-content-center gap-3 mt-4">
        <a href="https://github.com/Json0713/Json0713" target="_blank" rel="noopener noreferrer" aria-label="Coffee">
          <i class="bi bi-cup-hot-fill" style="font-size: 1.75rem; color: var(--gray);"></i>
        </a>
        <a href="https://github.com/Json0713/my-portfolio" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
